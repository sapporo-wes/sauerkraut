...
id: bcftools-extract-by-region-from-vcfgz-to-vcfgz
label: bcftools-extract-by-region-from-vcfgz-to-vcfgz
cwlVersion: v1.1
...
outputs:
  - id: out_vcf
    type: File
    outputBinding:
      glob: $(inputs.vcf.nameroot).$(inputs.region_name).vcf.gz

arguments:
  - position: 3
    prefix: -o 
    valueFrom: $(inputs.vcf.nameroot).$(inputs.region_name).vcf.gz
  - position: 4
    prefix: -O
    valueFrom: z
